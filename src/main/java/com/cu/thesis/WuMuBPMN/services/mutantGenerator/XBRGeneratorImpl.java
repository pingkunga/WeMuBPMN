...
public class XBRGeneratorImpl extends mutantGeneratorBase implements mutantGenerator
{
    @Override
    ...
    public List<String> GetAvaliableOperatorbyType() {
        return Collections.unmodifiableList(Arrays.asList("None", "One", "All", "Complex"));
    }
